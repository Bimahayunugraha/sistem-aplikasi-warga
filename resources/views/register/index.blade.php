...
@section('content')
    <div class="container">
        <div class="max-w-screen min-h-screen flex items-center justify-center px-2 pt-9 lg:pt-10">
            <div class="text-gray-500 rounded-3xl shadow h-full w-full overflow-hidden" style="max-width:1200px">
                <div class="md:flex w-full">
                    <div class="hidden md:block w-1/2 bg-indigo-500 py-10 px-10">
                        <svg id="a87032b8-5b37-4b7e-a4d9-4dbfbe394641" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                            width="100%" height="100%" viewBox="0 0 744.84799 747.07702">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="font-bold text-3xl text-dark">REGISTER</h1>
                            <p class="text-base mt-2">Masukkan informasi Anda untuk melakukan register</p>
                        </div>
                            ...
                            <div>
                                <div class="flex -mx-3">
                                    <div class="w-1/2 px-3 mb-5">
                                        <label for="name" class="text-xs font-semibold px-1">Nama</label>
                                        <div class="flex">
                                            <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                                <i class="far fa-user text-primary text-lg"></i>
                                            </div>
                                            <input type="text" name="name" id="name"
                                                class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg bg-gray-200 border focus:border-blue-500 focus:bg-white focus:outline-none @error('name') is-invalid border-red-500 @enderror"
                                                placeholder="Masukkan nama" value="{{ old('name') }}" autofocus autocomplete required>
                                        </div>
                                        @error('name')
                                    ...
                                    <div class="w-1/2 px-3 mb-5">
                                        ...
                                        <div class="flex">
                                            ...
                                            class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg bg-gray-200 border focus:border-blue-500 focus:bg-white focus:outline-none @error('username') is-invalid border-red-500 @enderror"
                                ...
                                <div class="flex -mx-3">
                                    <div class="w-full px-3 mb-5">
                                        <label for="address" class="text-xs font-semibold px-1">Alamat</label>
                                        <div class="flex">
                                            <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                                <i class="far fa-lock-alt text-primary text-lg"></i>
                                            </div>
                                            <input type="text" name="address" id="address"
                                            class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg bg-gray-200 border focus:border-blue-500 focus:bg-white focus:outline-none @error('address') is-invalid border-red-500 @enderror"
                                ...
                                <div class="flex -mx-3">
                                    <div class="w-full px-3 mb-5">
                                        <label for="phone" class="text-xs font-semibold px-1">No HP</label>
                                        <div class="flex">
                                            <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                                <i class="far fa-lock-alt text-primary text-lg"></i>
                                            </div>
                                            <input type="text" name="phone" id="phone"
                                            class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg bg-gray-200 border focus:border-blue-500 focus:bg-white focus:outline-none @error('phone') is-invalid border-red-500 @enderror"
                                            placeholder="Masukkan nohp" value="{{ old('phone') }}" required>
                                        </div>
                                        @error('phone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="flex -mx-3" x-data="{ show: true }">
                                    <div class="w-full px-3 mb-5">
                                        ...
                                        <div class="flex">
                                            ...
                                            class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg bg-gray-200 border focus:border-blue-500 focus:bg-white focus:outline-none @error('password') is-invalid border-red-500 @enderror"
                                            placeholder="Masukkan password" value="{{ old('password') }}" required>
                                            <div class="w-10 z-10 pl-1 text-center cursor-pointer flex items-center justify-center leading-5">
                                                <i class="far fa-eye text-dark" @click="show = !show"
                                                :class="{'hidden': !show, 'block':show }"></i>
                                                <i class="far fa-eye-slash text-dark" @click="show = !show"
                                ...
                                {{-- <div class="flex -mx-3" x-data="{ show: true }">
                                    <div class="w-full px-3 mb-12">
                                        <label for="password" class="text-xs font-semibold px-1">Konfirmasi Password</label>
                                        <div class="flex">
                                            <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                                <i class="far fa-lock-alt text-primary text-lg"></i>
                                            </div>
                                            <input :type="show ? 'password' : 'text'" name="password" id="password"
                                            class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg bg-gray-200 border focus:border-blue-500 focus:bg-white focus:outline-none @error('password') is-invalid border-red-500 @enderror"
                                            placeholder="Masukkan konfirmasi password" value="{{ old('password') }}" required>
                                            <div class="w-10 z-10 pl-1 text-center cursor-pointer flex items-center justify-center leading-5">
                                                <i class="far fa-eye text-dark" @click="show = !show"
                                                :class="{'hidden': !show, 'block':show }"></i>
                                                <i class="far fa-eye-slash text-dark" @click="show = !show"
                                ...
                                <div class="flex -mx-3">
                                    <div class="w-full px-3 mb-2">
                                        <p class="mt-3 block w-full max-w-xs mx-auto text-center">
                                            Sudah memiliki akun?
